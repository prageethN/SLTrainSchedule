...
namespace PrototypeBeta
{
    public partial class App : Application
    {
        ...
        void setCustomTheme()
        {
            ...
            (App.Current.Resources["PhoneAccentBrush"] as SolidColorBrush).Color = Color.FromArgb(255, 0, 171, 238);
        }
        ...
        private async void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            //{
                ...
                string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "trainschedule.db"));
                try
                {
                    // Try to get the 
                ...
                catch (FileNotFoundException)
                {
                    if (dbFile == null)
                    {
                        ...
                        using (Stream input = Application.GetResourceStream(new Uri("Database/trainschedule.db", UriKind.Relative)).Stream)
                        {
